...
describe('tfiwm.distributetransclude module', function() {
    ...
    describe('The trans-select selectors should be appended with the content', function () {
    ...
    describe('The trans-select selectors with trans-replace should be replaced with the content', function() {
